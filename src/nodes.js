...
const trendingPreviewSeries = document.querySelector('#trendingPreviewSeries');
...
const categoriesSeriesPreviewList = document.querySelector('.categoriesSeriesPreview-list')
...
const trendingBtnSeries = document.querySelector('.trendingPreviewSeries-btn'); 
